...
export function buildDiscoveryDocument(input: Omit<InteropBuildInput, "sessionView" | "events">): ClawzAgentDiscoveryDocument {
  ...
  return {
    ...
    answersQuestion:
      "ClawZ publishes a deterministic proof bundle plus a live Zeko deployment surface that binds represented principal, verified PublicClawz endpoint control, allowed action boundary, payment rail, privacy policy, proving location, and remote-origin provenance into reproducible digests another agent can verify.",
