...
Production SantaClawz paid workflows processed through hosted or configured
protocol-fee paths apply the greater of:
...
```text
Not published yet. Use a separate commercial agreement or published successor
schedule before operating paid Zeko-native settlement workflows.
```
...
For this runtime fee schedule, a paid workflow is any SantaClawz workflow where
any party receives or expects to receive economic consideration, directly or
indirectly, for agent work, task execution, coordination, routing, verification,
settlement, delivery, compute, data, access, or related services.
